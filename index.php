                ...
                <div class="home-wrapper">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="home-content text-center">
                            <h1>Publication Information Archive Nanosite</h1>
                        ...
                        <div class="portfolio-one">
                            ...
                            <div class="col-sm-4 col-xs-12 portfolio-item transition metal " data-category="transition">
                                <div class="single_portfolio_img">
                                    <a class="portfolio-img" href="images/portfolio/1.jpg"><img
                                                src="images/portfolio/1.jpg" alt=""/></a>
                            ...
                            <div class="col-sm-4 col-xs-12 portfolio-item metalloid " data-category="metalloid">
                                <div class="single_portfolio_img">
                                    <a class="portfolio-img" href="images/portfolio/2.jpg"><img
                                                src="images/portfolio/2.jpg" alt=""/></a>
                                    <h2>Neque Porro Quisquam</h2>
                                </div>

                            </div>

                            <div class="col-sm-4 col-xs-12 portfolio-item post-transition metal "
                                 data-category="post-transition">
                                <div class="single_portfolio_img">
                                    <a class="portfolio-img" href="images/portfolio/3.jpg"><img
                                                src="images/portfolio/3.jpg" alt=""/></a>
                                    <h2>Neque Porro Quisquam</h2>
                                </div>
                            ...
                            <div class="col-sm-4 col-xs-12 portfolio-item alkali " data-category="transition">
                                <div class="single_portfolio_img">
                                    <a class="portfolio-img" href="images/portfolio/4.jpg"><img
                                                src="images/portfolio/1.jpg" alt=""/></a>
                                    <h2>Neque Porro Quisquam</h2>
                                </div>
                            ...
                            <div class="col-sm-4 col-xs-12 portfolio-item alkali metal " data-category="alkali">
                                <div class="single_portfolio_img">
                                    <a class="portfolio-img" href="images/portfolio/5.jpg"><img
                                                src="images/portfolio/5.jpg" alt=""/></a>
                                    <h2>Neque Porro Quisquam</h2>
                                </div>
                            ...
                            <div class="col-sm-4 col-xs-12 portfolio-item alkali metal " data-category="alkali">
                                <div class="single_portfolio_img">
                                    <a class="portfolio-img" href="images/portfolio/6.jpg"><img
                                                src="images/portfolio/6.jpg" alt=""/></a>
                                    <h2>Neque Porro Quisquam</h2>
                                </div>
...
<div id="register-login-form-show-hide">
    <div>
        <form action="/user/login" method="post" id="login-form" class="register-login-form">
            ...
            <div class="dialog-actions">
                <a href="#" id="login-register-cancel">Cancel</a>
            </div>
        </form>

        <form id="register-form" class="register-login-form">
            <div class="dialog-header">
